...
class AssertionAggregateTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $assertion = $this->getMockForAbstractClass(
    ...
    {
        $assertions[] = $this->getMockForAbstractClass(
                '\Zend\Permissions\Acl\Assertion\AssertionInterface');
        $assertions[] = $this->getMockForAbstractClass(
                '\Zend\Permissions\Acl\Assertion\AssertionInterface');
        ...
        $this->assertAttributeEquals($assertions, 'assertions', 
                $this->assertionAggregate);
    ...
    {
        $this->assertAttributeEquals(AssertionAggregate::MODE_ALL, 'mode', 
                $this->assertionAggregate);
    }
    ...
    public function testSetMode ($mode, $exception = false)
    {
        if ($exception) {
            ...
            $this->assertionAggregate->setMode($mode);
            $this->assertAttributeEquals($mode, 'mode', 
                    $this->assertionAggregate);
        }
    }
    ...
    public function testManagerAccessors ()
    {
        ...
        $this->assertAttributeEquals($manager, 'assertionManager', 
                $this->assertionAggregate);
        $this->assertEquals($manager, 
                $this->assertionAggregate->getAssertionManager());
        $this->assertSame($this->assertionAggregate, $aggregate);
    }
    ...
    public function testCallingAssertWillFetchAssertionFromManager ()
    {
        ...
        $resource = $this->getMock(
                '\Zend\Permissions\Acl\Resource\GenericResource', array(), 
                array(
                        'test.resource'
                ));
        ...
        $this->assertTrue(
                $this->assertionAggregate->assert($acl, $role, $resource, 
                        'privilege'));
    }
    ...
    public function testAssertWithModeAtLeastOne ()
    {
        ...
        $this->assertionAggregate->setMode(
                AssertionAggregate::MODE_AT_LEAST_ONE);
        $this->assertTrue(
                $this->assertionAggregate->assert($acl, $role, $resource, 
                        'privilege'));
